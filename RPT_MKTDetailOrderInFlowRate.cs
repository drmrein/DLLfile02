...
// Type: MF.Report.Marketing.Web.RPT_MKTDetailOrderInFlowRate
...
{
  public class RPT_MKTDetailOrderInFlowRate : WebFormBase
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      {
        new FixedSearchPropSpec("ltl_App_AppDtFrom_Search", "FromOrderIn", typeof (DateTime), true, (SearchPropSpec.SearchCondition) 0, false, (SearchPropSpec.ValOptType) 0, false),
        new FixedSearchPropSpec("ltl_App_AppDtTo_Search", "ToOrderIn", typeof (DateTime), true, (SearchPropSpec.SearchCondition) 0, false, (SearchPropSpec.ValOptType) 0, false),
      ...
      {
        new ReportTemplateParam("prFromOrderIn", str4, new string[1]
        {
          "FromOrderIn"
        }),
        new ReportTemplateParam("prToOrderIn", str5, new string[1]
        {
          "ToOrderIn"
        }),
